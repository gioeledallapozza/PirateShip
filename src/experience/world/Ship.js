...
export default class Ship 
{
    ...
    setModel() 
    {
        ...
        // this.model.visible = false // Nascondi la nave all'inizio per evitare arte
    }
      ...
      if(this.debug.active)
        {
            ...
            posFolder.add(this.params, 'z').name('Z').min(-250).max(200).step(0.1).onChange(() => this.updateModel())
            posFolder.close()
